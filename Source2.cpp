...
void damageDo(int &nr, int& laikas, Sprite enemyones, Sprite enemyoneh, Sprite enemyonea, Text praleisti, Text pasigydyti, Text ataka, bool& vyksta, Sprite tarah, Sprite tarahsa, Sprite tarahsh) {
    //---------------------------------------------------------veikia attack;
    if (nr == 1) {
        if (laikas < 50) {
            langas.clear();
...
void enemyone(Sprite enemyones, Sprite enemyoneh, Sprite enemyonea, Text praleisti, Text pasigydyti, Text ataka, int &laikas, bool &vyksta, Sprite tarah, Sprite tarahsa, Sprite tarahsh) {
    ...
    if (ison(pozicija, 250, 350, 150, 250)&&vyksta==false) {
        ...
        damageDo(nr1, laikas, enemyones, enemyoneh, enemyonea, praleisti, pasigydyti, ataka, vyksta, tarah, tarahsa, tarahsh);
    }
    else if(mvnr==1) {
        //langas.draw(enemyones);
